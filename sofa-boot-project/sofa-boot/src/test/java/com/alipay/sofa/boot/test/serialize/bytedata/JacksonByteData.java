 ...
 *
 * @author xunfang
 * @version JacksonByteData.java, v 0.1 2023/7/17
 */
public class JacksonByteData extends BaseData{
    ...
    static {
        ...
        object_1_Bytes = new byte[]{123, 34, 105, 110, 116, 86, 97, 114, 34, 58, 48, 44, 34, 108, 111, 110, 103, 86, 97, 114, 34, 58, 48, 44, 34, 102, 108, 111, 97, 116, 86, 97, 114, 34, 58, 48, 46, 48, 44, 34, 100, 111, 117, 98, 108, 101, 86, 97, 114, 34, 58, 48, 46, 48, 44, 34, 115, 116, 114, 105, 110, 103, 86, 97, 114, 34, 58, 110, 117, 108, 108, 44, 34, 101, 110, 117, 109, 86, 97, 114, 34, 58, 110, 117, 108, 108, 44, 34, 115, 117, 98, 79, 98, 106, 101, 99, 116, 34, 58, 110, 117, 108, 108, 125};
        ...
        object_3_Bytes = new byte[]{91, 123, 34, 105, 110, 116, 86, 97, 114, 34, 58, 49, 44, 34, 108, 111, 110, 103, 86, 97, 114, 34, 58, 48, 44, 34, 102, 108, 111, 97, 116, 86, 97, 114, 34, 58, 48, 46, 48, 44, 34, 100, 111, 117, 98, 108, 101, 86, 97, 114, 34, 58, 48, 46, 48, 44, 34, 115, 116, 114, 105, 110, 103, 86, 97, 114, 34, 58, 110, 117, 108, 108, 44, 34, 101, 110, 117, 109, 86, 97, 114, 34, 58, 110, 117, 108, 108, 44, 34, 115, 117, 98, 79, 98, 106, 101, 99, 116, 34, 58, 110, 117, 108, 108, 125, 44, 123, 34, 105, 110, 116, 86, 97, 114, 34, 58, 50, 44, 34, 108, 111, 110, 103, 86, 97, 114, 34, 58, 48, 44, 34, 102, 108, 111, 97, 116, 86, 97, 114, 34, 58, 48, 46, 48, 44, 34, 100, 111, 117, 98, 108, 101, 86, 97, 114, 34, 58, 48, 46, 48, 44, 34, 115, 116, 114, 105, 110, 103, 86, 97, 114, 34, 58, 110, 117, 108, 108, 44, 34, 101, 110, 117, 109, 86, 97, 114, 34, 58, 110, 117, 108, 108, 44, 34, 115, 117, 98, 79, 98, 106, 101, 99, 116, 34, 58, 110, 117, 108, 108, 125, 93};
        object_4_Bytes = new byte[]{91, 123, 34, 105, 110, 116, 86, 97, 114, 34, 58, 48, 44, 34, 108, 111, 110, 103, 86, 97, 114, 34, 58, 48, 44, 34, 102, 108, 111, 97, 116, 86, 97, 114, 34, 58, 48, 46, 48, 44, 34, 100, 111, 117, 98, 108, 101, 86, 97, 114, 34, 58, 48, 46, 48, 44, 34, 115, 116, 114, 105, 110, 103, 86, 97, 114, 34, 58, 110, 117, 108, 108, 44, 34, 101, 110, 117, 109, 86, 97, 114, 34, 58, 110, 117, 108, 108, 44, 34, 115, 117, 98, 79, 98, 106, 101, 99, 116, 34, 58, 110, 117, 108, 108, 125, 44, 123, 34, 105, 110, 116, 86, 97, 114, 34, 58, 48, 44, 34, 108, 111, 110, 103, 86, 97, 114, 34, 58, 48, 44, 34, 102, 108, 111, 97, 116, 86, 97, 114, 34, 58, 48, 46, 48, 44, 34, 100, 111, 117, 98, 108, 101, 86, 97, 114, 34, 58, 48, 46, 48, 44, 34, 115, 116, 114, 105, 110, 103, 86, 97, 114, 34, 58, 110, 117, 108, 108, 44, 34, 101, 110, 117, 109, 86, 97, 114, 34, 58, 110, 117, 108, 108, 44, 34, 115, 117, 98, 79, 98, 106, 101, 99, 116, 34, 58, 110, 117, 108, 108, 125, 93};
    ...
    public void validate(byte[] bytes, Object obj, String type) throws Exception {
        ...
        if (type.equals("byte[]")) {
            isEqual(obj, objectMapper.readValue(bytes, new TypeReference<byte[]>(){}), type);
        } else if (type.equals("date")) {
            isEqual(obj, objectMapper.readValue(bytes, new TypeReference<Date>(){}), type);
        } else if (type.equals("double")) {
            isEqual(obj, objectMapper.readValue(bytes, new TypeReference<Double>(){}), type);
        } else if (type.equals("long")) {
            isEqual(obj, objectMapper.readValue(bytes, new TypeReference<Long>(){}), type);
        } else if (obj instanceof List && type.equals("object")) {
            isEqual(obj, objectMapper.readValue(bytes, new TypeReference<List<TestObject>>(){}), type);
        } else if (type.equals("object")) {
            isEqual(obj, objectMapper.readValue(bytes, new TypeReference<TestObject>(){}), type);
        } else if (type.equals("list") || type.equals("string[]") ) {
            isEqual(obj, objectMapper.readValue(bytes, new TypeReference<List<String>>(){}), type);
        } else {
